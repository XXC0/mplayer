#############################################################################
# Makefile for building: mplayer1
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? 9? 6 18:51:13 2019
# Project:  mplayer1.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.7.0/bin/qmake -spec /usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++ -o Makefile mplayer1.pro
#############################################################################
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++ -I. -I/usr/local/Trolltech/Qt-4.7.0/include/QtCore -I/usr/local/Trolltech/Qt-4.7.0/include/QtGui -I/usr/local/Trolltech/Qt-4.7.0/include -I.
LINK          = g++
...
SOURCES       = main.cpp \
		widget.cpp \
		lyc.cpp \
		gb2312_ucs2.cpp moc_widget.cpp \
		qrc_Image.cpp
OBJECTS       = main.o \
		widget.o \
		lyc.o \
...
Makefile: mplayer1.pro  /usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.7.0/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.7.0/mkspecs/modules/qt_webkit_version.pri \
	...
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.7.0/mkspecs/linux-g++ -o Makefile mplayer1.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/mplayer11.0.0 || $(MKDIR) .tmp/mplayer11.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mplayer11.0.0/ && $(COPY_FILE) --parents widget.h lrc.h gb2312_ucs2.h .tmp/mplayer11.0.0/ && $(COPY_FILE) --parents Image.qrc .tmp/mplayer11.0.0/ && $(COPY_FILE) --parents main.cpp widget.cpp lyc.cpp gb2312_ucs2.cpp .tmp/mplayer11.0.0/ && (cd `dirname .tmp/mplayer11.0.0` && $(TAR) mplayer11.0.0.tar mplayer11.0.0 && $(COMPRESS) mplayer11.0.0.tar) && $(MOVE) `dirname .tmp/mplayer11.0.0`/mplayer11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mplayer11.0.0
...
lyc.o: lyc.cpp lrc.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lyc.o lyc.cpp

gb2312_ucs2.o: gb2312_ucs2.cpp gb2312_ucs2.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gb2312_ucs2.o gb2312_ucs2.cpp
